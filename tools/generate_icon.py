...
""")
    ...
    # Unqualified rather than the usual mipmap-anydpi-v26. That folder exists so a
    # pre-26 device can fall back to a PNG, and minSdk 34 leaves no such device,
    # so a qualifier would only add a variant that always wins anyway.
    adaptive = res / "mipmap" / "ic_launcher.xml"
...
""")
    ...
    return [foreground, background, adaptive]
